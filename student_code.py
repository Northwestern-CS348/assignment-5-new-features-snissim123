...
def buildFeatureStatement(tree):
    ...
    references = core.resolveObjectFOPC(mySub)
    ...
    prepPhrase = core.findAndAttachPrepObjectsFOPC(myRoot, mySub, references)
    ...
    myFeatures = core.findAndAssertFeaturesFOPC(myRoot, references)

    ##### Your code to findAndAssertDefinitionsFOPC -- this takes the root and your names
    myDef = core.findAndAssertDefinitionsFOPC(myRoot, references)
